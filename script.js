...
const sugerencia = document.querySelector('.form_sugerencia');
const desencriptarMsg = document.querySelector('.desencriptar_mensaje');
const desencriptarResultado = document.querySelector('.desencriptar_resultado');
